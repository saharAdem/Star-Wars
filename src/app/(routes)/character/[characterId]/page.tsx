      ...
      <div className="block w-4/5 m-auto rounded-lg p-6 ">
        <Card title='' className="w-2/6" imageData={{ url: image, width: 400, height: 350 }}>
          <div className="px-6 pb-4">
            {mass && <CharacterDescriptionItem propertey="Mass" value={mass} />}
            {birthYear && <CharacterDescriptionItem propertey="Birthdate" value={birthYear} />}
            {height && <CharacterDescriptionItem propertey="Height" value={height} />}
            {filmsTitles.length > 0 && <CharacterDescriptionItem propertey="Films">
              {
